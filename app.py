...
cluster = MongoClient("mongodb+srv://araman:araman@cluster0.z2lknhh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = cluster["bakery"]
users = db["users"]
orders = db["orders"]
